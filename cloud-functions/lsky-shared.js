/**
 * Lsky Lite 共享模块 — 被 index.js 和 api/lsky.js 共同引用
 */
...
async function handleUpload (request) {
  ...
  if (ct.includes('multipart/form-data')) {
    ...
    return new Response(JSON.stringify({ error: '不支持的 Content-Type' }), { status: 400, headers: cors() })
  }
...
/** Lsky 路由入口：被 index.js 和 api/lsky.js 调用 */
export async function lskyRouter (context) {
